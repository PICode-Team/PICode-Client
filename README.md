...
3. Enter `PORT=frontServerPortNum NEXT_FE_API_URL=be_url, NEXT_WS_PORT=ws_port, NEXT_PUBLIC_WS_URL=frontendUrl(not includes port)` in env file. (essential)
5. Enter NODE_ENV=production in .env file. (essential)
