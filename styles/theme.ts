...
export const darkTheme = createTheme({
  ...
  brightness: {
    step0: 'brightness(1.2)',
    step1: 'brightness(1.3)',
    step2: 'brightness(1.4)',
    step3: 'brightness(1.5)',
    step4: 'brightness(1.6)',
  },
} as any)
...
export const whiteTheme = createTheme({
  ...
  brightness: {
    step0: 'brightness(1.1)',
    step1: 'brightness(1.0)',
    step2: 'brightness(0.9)',
    step3: 'brightness(0.8)',
    step4: 'brightness(0.7)',
  },
} as any)
